  ...
  return (
    <div className="planner__left">
      ...
      <div className="drivers__header">
        ...
        <IconButton icon="link" handleClick={() => toggleRestLink(true)} />
        <IconButton icon="plus" handleClick={() => toggleAddModal(true)} />
      </div>
      ...
      <div className="drivers__container">
        ...
        {driverList.columnOrder.map(columnId => {
          ...
          const passengers = driver.passengerIds.map(
            passenger => driverList.passengerRows[passenger]
          );
